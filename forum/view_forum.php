...
$chk = $conn->query("SELECT * FROM forum_views where  topic_id=$id and user_id='{$_SESSION['user_id']}' ")->num_rows;
if($chk <= 0){
	$conn->query("INSERT INTO forum_views set  topic_id=$id , user_id='{$_SESSION['user_id']}' ");
}
}
